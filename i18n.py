...
MESSAGES: dict[str, dict[str, str]] = {
    "zh-Hant": {
        "meta.description": "採訊 — 短片帶貨腳本診斷：開頭鉤子、同質化、CTA、留低睇完動力。",
        "meta.title": "採訊 CoiSeon — 短片腳本診斷",
        "brand.name": "採訊",
        "brand.logo_alt": "採訊標誌",
        "nav.how": "點用",
        "nav.fields": "邊啲場景啱用",
        ...
        "lang.zh-Hans": "简",
        "lang.en": "EN",
        "hero.h1": "上載短片定貼腳本，即刻幫你診斷。",
        "hero.lede": "可以上載帶貨短片自動轉口播字，再由開頭鉤子、同質化、行動號召同留低睇完動力四方面俾建議你。",
        "hero.cta_primary": "開始檢測短片",
        "hero.cta_secondary": "睇診斷流程",
        "how.kicker": "診斷流程",
        "how.h2": "三步，將腳本變成可以照住改嘅診斷。",
        "how.lede": "唔使逐句人手批註。填好舖頭資料同腳本，系統就會出四維評分同最優先要改嘅位。",
        "how.step1.title": "上載短片定貼腳本",
        "how.step1.body": "上載你有權用嘅短片檔案，或者直接貼口播／分鏡文案。",
        "how.step2.title": "轉寫同四維診斷",
        "how.step2.body": "短片會先轉成口播文字，再評鉤子、同質化、CTA、留低睇完動力。",
        "how.step3.title": "拎出優先改進",
        "how.step3.body": "每個維度都有高／中／低評分同建議，仲標低邊樣最應該先改。",
        "fields.kicker": "邊啲場景啱用",
        "fields.h2": "專為小商戶帶貨短片而設。",
        "fields.lede": "啱舖頭老闆、代營運同內容審校——先睇清腳本問題，再決定下一條點改。",
        "fields.item1.title": "舖頭自查",
        "fields.item1.body": "快手睇下自己口播係咪太平、有冇 CTA、開頭夠唔夠勾人。",
        "fields.item2.title": "代營運批改",
        "fields.item2.body": "一次過對照唔同商戶腳本，統一診斷維度同改進優先次序。",
        "fields.item3.title": "行業對標",
        "fields.item3.body": "按行業存低診斷結果，之後可以同業比較基準。",
        "fields.item4.title": "內容審校",
        "fields.item4.body": "出街前檢查同質化同完播節奏，減低「淨係報價」嗰啲片。",
        "start.h2": "開始檢測短片",
        "start.lede": "上載短片（自動轉口播），或者貼腳本；揀一樣就得。",
        "form.shop": "舖名",
        ...
        "form.video": "上載短片／音訊（可選）",
        "form.script": "或者直接貼腳本（可選）",
        "form.script_ph": "如果唔上載短片，可以喺呢度貼口播文案或者分鏡腳本……",
        "form.submit": "開始診斷",
        "form.submitting": "診斷緊…",
        "form.submitting_video": "轉寫同診斷緊…",
        "form.fineprint": "診斷走浸會 GenAI（HKBU）。香港通常用唔到官方 OpenAI，所以唔使直連。上載短片轉寫仍要另設 Whisper／智譜 Key；冇嘅話請貼腳本。請淨係上載你有權用嘅內容。",
        "result.priority": "優先改進",
        "result.file": "檔案",
        "result.source": "診斷來源：",
        "result.source_hkbu": "浸會 GenAI",
        "result.source_zhipu": "智譜 AI",
        "result.source_openai": "OpenAI",
        "result.source_deepseek": "DeepSeek",
        "result.source_local": "本地規則",
        "result.video_id": "影片 ID",
        "result.dims": "四維診斷",
        "result.radar": "能力雷達",
        "result.radar_note": "四軸愈外愈好。差異化由「內容同質化」反轉：同質化愈高，呢軸愈短。",
        "result.radar_distinct": "差異化",
        "result.radar_cta": "CTA",
        "result.hook": "開頭鉤子",
        "result.homogeneity": "內容同質化",
        "result.cta": "行動號召 CTA",
        "result.retention": "留低睇完動力",
        "result.cta_yes": "有",
        "result.cta_no": "冇",
        ...
        "score.mid": "中",
        "score.low": "低",
        "footer.tagline": "短片腳本診斷 · Python / Flask",
        "flash.need_shop": "請填返舖名同行業。",
        "flash.need_input": "請上載短片，或者貼腳本文案（揀一樣就得）。",
        "flash.script_short": "腳本內容太短，請貼返齊啲嘅口播／分鏡文案。",
        "flash.fail_prefix": "診斷失敗：",
        "flash.ok_video": "已經由「{name}」轉寫口播並完成診斷。",
        "flash.ok_local": "已經完成本地規則診斷（未設定對應語系嘅 API Key）。",
        "flash.ok_ai": "已經完成 AI 診斷，結果已寫入資料庫。",
    },
    "zh-Hans": {
        ...
        "form.fineprint": "诊断走浸会 GenAI（HKBU）。香港通常用不了官方 OpenAI，因此不直连。上传短视频转写仍需另设 Whisper／智谱 Key；没有的话请贴脚本。请只上传你有权使用的内容。",
        "result.priority": "优先改进",
        "result.file": "文件",
        "result.source": "诊断来源：",
        "result.source_hkbu": "浸会 GenAI",
        ...
        "result.dims": "四维诊断",
        "result.radar": "能力雷达",
        "result.radar_note": "四轴越靠外越好。差异化由「内容同质化」反转：同质化越高，该轴越短。",
        "result.radar_distinct": "差异化",
        "result.radar_cta": "CTA",
        "result.hook": "开头钩子",
        ...
        "flash.ok_local": "已完成本地规则诊断（未设置对应语系的 API Key）。",
    ...
    "en": {
        ...
        "form.fineprint": "Diagnosis uses HKBU GenAI. Direct OpenAI is often unavailable in Hong Kong, so we use the university gateway. Video ASR still needs a Whisper/Zhipu key; otherwise paste a script. Upload only content you have rights to use.",
        "result.priority": "Priority fix",
        "result.file": "File",
        "result.source": "Source:",
        "result.source_hkbu": "HKBU GenAI",
        ...
        "result.radar": "Capability radar",
        "result.radar_note": "Farther out is stronger. Distinctiveness inverts sameness: high sameness shortens that axis.",
        "result.radar_distinct": "Distinctiveness",
        "result.radar_cta": "CTA",
        ...
        "flash.ok_local": "Local-rule diagnosis done (no API key set for this language).",
